    ...
    public class EvernoteUserManager : ManagerBase<EvernoteUser>
    {
        public BusinessLayerResult<EvernoteUser> RegisterUser(RegisterViewModel data)
        {
            ...
            if (user != null)
            {
                ...
                {
                    res.AddError(ErrorMessageCode.EmailAlreadyExists, "E-posta adresi kayıtlıdır.");
                }
            }
            else
            {
                ...
                if (dbResult > 0)
                {
                    ...
                    string activaUri = $"{siteUri}/Home/UserActivate/{res.Result.ActivateGuid}";
                    string body = $"Merhaba {res.Result.Username};<br><br>Hesabınızı aktifleştirmek için <a href='{activaUri}' target='_blank'>tıklayınız</a>.";

                    MailHelper.SendMail(body, res.Result.Email, "MayEvernote Hesap Aktifleştirme");
                }
            }
        ...
        public BusinessLayerResult<EvernoteUser> LoginUser(LoginViewModel data)
        {
            ...
            {
                res.AddError(ErrorMessageCode.UsernameOrPassWorg, "Kullanıcı adı yada şifre uyuşmuyor.");
            }
